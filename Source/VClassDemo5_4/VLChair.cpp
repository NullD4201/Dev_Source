...
AVLChair::AVLChair()
{
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh> VL_CHAIR(TEXT("/Game/Models/plastic_monobloc_chair_01_4k.plastic_monobloc_chair_01_4k"));
	if (VL_CHAIR.Succeeded()) {
		Body->SetStaticMesh(VL_CHAIR.Object);
	}
